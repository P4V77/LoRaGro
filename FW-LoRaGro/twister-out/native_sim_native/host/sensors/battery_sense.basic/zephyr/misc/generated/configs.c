...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_INIT_PRIORITY, 80);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_INIT_PRIORITY, 90);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_P4V_FAKE_REGULATOR_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_P4V_SENSOR_SCD41_FAKE_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORAGRO_FAKE_DRIVERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REGULATOR_P4V_FAKE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REGULATOR_P4V_FAKE_INIT_PRIORITY, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_P4V_SCD41_FAKE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_P4V_FAKE_SCD41_INIT_PRIORITY, 60);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_LORAGRO_COMMON_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KERNEL_INIT_PRIORITY_DEVICE, 90);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_EMUL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_EMUL_ACQUISITION_THREAD_STACK_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_EMUL_ACQUISITION_THREAD_PRIO, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_INIT_PRIORITY, 90);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXTERNAL_LIBCPP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NATIVE_LIBCPP, 1);
